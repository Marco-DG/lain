...
static void* file_map_rw(file handle, int64 length) /* length should be = file size; also, i think length gets always page aligned */
{
#if FILE_DEBUG
