...
function-declaration  ::=
    ...
    [ effects-clause ] [ "decreasing" expression ]
    block-statement

effects-clause        ::= "effects" [ effect-name { "," effect-name } ]

effect-name           ::= "io" | "diverge" | "raises" | "alloc"

(* REMOVED: `proc` granted the effects that the row now states. The keyword remains
   reserved and diagnoses the replacement. *)
