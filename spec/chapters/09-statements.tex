...
\begin{enumerate}
  ...
  \item \textbf{Analyzable measure} (\diagcode{E081}): $M$ shall be in a form
        from which the termination checker can extract the variables it
        depends on.  A measure the checker cannot analyze at all is rejected
        with \diagcode{E081}.  (A well-formed measure that merely fails to
        stay non-negative or to decrease --- including a constant, or one
        over variables the body never assigns --- is reported by
        \diagcode{E080}.)
