...
\begin{enumerate}
  ...
  \item If no matching function is found, the call is unresolved.  (The
        reference implementation does not yet emit a dedicated diagnostic for
        an unresolved UFCS call --- it shares the undeclared-identifier gap
        noted in \S\,\ref{sec:basics.resolution}.)
\end{enumerate}
