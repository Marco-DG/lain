...
\begin{constraint}
  ...
  \lain{unsafe} blocks.  Only raw pointer operations, direct ADT field
  access, and the bounds-check requirement are relaxed.  An implementation
  shall continue to enforce the ownership and linearity diagnostics
  (\diagcode{E001}--\diagcode{E008} and \diagcode{E016}) inside
  \lain{unsafe} blocks.
\end{constraint}
