...
- [~] **2.5 Consumers:** **bounds check** (`0 ≤ idx < len` for fixed arrays *and* slices) done
      and validated — proves the safe patterns, refuses off-by-one/over-bound/unguarded. TODO:
      overflow, div-by-zero, refinement types, termination.
